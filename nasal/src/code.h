...
enum {    
    ...
    OP_JMP, OP_JIF, OP_JIFNIL, OP_FCALL, OP_MCALL, OP_RETURN,
    OP_PUSHCONST, OP_PUSHZERO, OP_PUSHNIL, OP_POP, OP_DUP, OP_XCHG,
    OP_INSERT, OP_EXTRACT, OP_MEMBER, OP_SETMEMBER, OP_LOCAL,
    OP_SETLOCAL, OP_NEWVEC, OP_VAPPEND, OP_NEWHASH, OP_HAPPEND,
    OP_LINE
};
